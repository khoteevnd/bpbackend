...
* ********************************************
* */
var $btnTop = __WEBPACK_IMPORTED_MODULE_0_jquery__(".btn-top");
__WEBPACK_IMPORTED_MODULE_0_jquery__(window).on("scroll", function () {
	if (__WEBPACK_IMPORTED_MODULE_0_jquery__(window).scrollTop() >= 150) $btnTop.fadeIn();else $btnTop.fadeOut();
});

$btnTop.on("click", function (event) {
	console.log("click");
	event.preventDefault();
	__WEBPACK_IMPORTED_MODULE_0_jquery__('html, body').animate({ scrollTop: 0 }, 600);
});
 ...
 * ********************************************
 * */
__WEBPACK_IMPORTED_MODULE_0_jquery__(document).on('click', 'a', function (event) {
	event.preventDefault();
	__WEBPACK_IMPORTED_MODULE_0_jquery__('html, body').animate({
		scrollTop: __WEBPACK_IMPORTED_MODULE_0_jquery__(__WEBPACK_IMPORTED_MODULE_0_jquery__["attr"](this, 'href')).offset().top
	}, 900);
});
